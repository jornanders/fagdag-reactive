...
import no.ciber.rxjava.exercises.ObservableExercises;
import no.ciber.rxjava.exercises.solutions.ObservableSolutions;
import no.ciber.rxjava.exercises.types.BoxArt;
import no.ciber.rxjava.exercises.types.JSON;
import no.ciber.rxjava.exercises.types.Movie;
import no.ciber.rxjava.exercises.types.Movies;
