package no.ciber.rxjava.exercises;

import no.ciber.rxjava.exercises.solutions.ComposableListSolutions;
import no.ciber.rxjava.exercises.types.Bookmark;
import no.ciber.rxjava.exercises.types.BoxArt;
import no.ciber.rxjava.exercises.types.ComposableList;
import no.ciber.rxjava.exercises.types.InterestingMoment;
import no.ciber.rxjava.exercises.types.JSON;
import no.ciber.rxjava.exercises.types.MovieList;
import no.ciber.rxjava.exercises.types.Video;
...
public class ComposableListExercises<T> extends ArrayList<T> implements ComposableList<T> {
    ...
    public static ComposableList<JSON> exercise3() {
        ...
        ComposableListExercises<JSON> videoAndTitlePairs = new ComposableListExercises<>();
    ...
    */
     ...
     */
    public static ComposableList<HashMap<Integer, String>> exercise18() {
